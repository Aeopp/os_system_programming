...
int _tmain(int argc, TCHAR* argv[])
{
	...
	(_T("data.dat"), GENERIC_READ | GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
	...
	TCHAR* pWrite =
		(TCHAR*)MapViewOfFile(hMapFile, FILE_MAP_READ, 0, 0, 0);

	if (pWrite == NULL)
	{
		_tprintf(_T("Coult not map view of file. \n"));
	}
