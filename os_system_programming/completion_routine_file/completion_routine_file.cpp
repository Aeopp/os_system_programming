...
TCHAR strData[] =
_T("WQEDSHXCXDJKASDHKJQWHEKJQWHKDGSJXCBVZXJHGDJAWEGHW\n")
_T("qwewqdjahsad\n")
_T("wqeqweqweqwe\n")
_T("wqeqweaskjdhjkxzc\n")
_T("dsadjhxzcxzc\n");
...
VOID WINAPI FileIOCompletionRoutine(DWORD errorCode, DWORD numOfBytesTransfered, LPOVERLAPPED
overlapped)
{
